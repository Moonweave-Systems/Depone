...
- `docs/spec.md` lacks the V87 brand boundary audit, V88 roadmap
  ...
  status, V91 contract tiering status, or V92 evidence oracle status.
- `docs/automation-roadmap.md` still says V12-V20 are planned but not
  implemented.
- `docs/automation-roadmap.md` lacks the V52-V92 continuation summary.
