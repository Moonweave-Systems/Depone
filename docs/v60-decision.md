...
The accepted suite covers `chart-review.json`, `chart-review.md`, missing receipt blocking,
rejected receipt blocking, stale receipt blocking, and overclaim blocking.
