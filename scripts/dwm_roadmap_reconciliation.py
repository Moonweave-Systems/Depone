...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V96: Product Evidence And Control Deck")
