...
def ready_roadmap_reconciliation() -> dict[str, Any]:
    return {"decision": "roadmap_reconciled", "blocked_by": [], "policy": {"latest_version": "V92"}}
...
def self_test() -> None:
    ...
    stale_roadmap = make_activation("self-test-stale-roadmap", ready_audit(), ready_receipt(), ready_run_status(), brand_audit=ready_brand_audit(), roadmap_reconciliation={"decision": "roadmap_reconciled", "blocked_by": [], "policy": {"latest_version": "V91"}}, command_safety=ready_command_safety())
