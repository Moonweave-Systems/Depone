...
def audit_surfaces(surfaces: dict[str, str]) -> dict[str, Any]:
    ...
    require_term(blockers, surfaces, "docs/spec.md", "V96 metric ladder, V97 benchmark readiness, V98 wave operator, V99 wave receipt, V100 promotion evidence, V101 promotion route")
    ...
    require_term(blockers, surfaces, "docs/automation-roadmap.md", "V52-V101: Product Evidence And Control Deck")
