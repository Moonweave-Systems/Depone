...
class CodexLocalCapabilityTests(unittest.TestCase):
    ...
    def test_deprecated_shim_delegates_to_witnessd_canonical_when_available(self) -> None:
        ...
        def fake_build(**kwargs: object) -> dict[str, object]:
            return {
                ...
                "readiness": {"version_probe": {"executed": False, "timed_out": False, "stdout_present": False, "stderr_present": False, "unexpected_output": False, "argv": ["codex", "--version"], "exit_code": None, "sanitized_version_text": None}},
                "boundary": {
                    "launches_live_model": False,
                    "executes_coding_task": False,
                    "captures_capability_only": True,
